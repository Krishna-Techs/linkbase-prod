        ...
        <div className="row align-items-center">
          ...
          <div className="col-xl-6 ps-xl-5 col-lg-6 col-12 mt-5 mt-lg-0">
            <div className="section-title-3">
              ...
              <p>Your keyless solution ties in directly with your guest web app making 
              it very convenient and intuitive for guests to access.</p>
            </div>
            <div className="checked-features-list style-2">
              <ul>
                <li>Guests unlock and lock the property using a button the app</li>
            ...
            <div className="section-title-3 mt-3">
              <p>You enjoy hassle free Check-ins without ever worrying about providing access codes to guests ever again.</p>
            </div>
          </div>
        </div>
      </div>
...
export default SmartLockSection2;
